--
-- SMARTCRM 2.0 — MASTER DATABASE SCHEMA
--
...
CREATE INDEX IF NOT EXISTS contacts_autopilot_idx ON contacts(autopilot_enabled);
...
CREATE INDEX IF NOT EXISTS agent_memory_contact_idx 
  ON agent_memory(contact_id);
