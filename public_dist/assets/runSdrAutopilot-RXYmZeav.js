...
- Use clear subject lines that sound human, not "marketing-y".
    `},{id:"course_creator_nurture",name:"Course Creator Lead Nurture",label:"📚 Course Creator",shortTag:"Course Creator",description:"A warm, creator-style persona that nurtures subscribers into buyers for digital courses and communities.",idealUseCases:["Course sales","Community building","Lead nurturing"],defaultTone:"warm, encouraging, helpful, mentor-like",systemPrompt:`
...
- Max 200 words. Use short paragraphs and skimmable structure.
    `},{id:"agency_retainer_builder",name:"Agency Retainer Builder",label:"🏢 Agency Builder",shortTag:"Agency",description:"Outbound persona for agencies selling monthly services like ads, content, or automations.",idealUseCases:["Agency services","Monthly retainers","Client acquisition"],defaultTone:"consultant, problem-solver, ROI-focused, calm",systemPrompt:`
...
- Make the CTA low-friction: "Want me to send over a quick 3–5 bullet audit?" or "Want a 10-min loom breaking down opportunities I see?"
    `},{id:"product_launch_outreach",name:"Product Launch Outreach",label:"🎉 Product Launch",shortTag:"Launch",description:"Persona for teasing new product launches and building an early response list.",idealUseCases:["Product launches","Beta testing","Early access campaigns"],defaultTone:"exciting, confident, but grounded (no hype fluff)",systemPrompt:`
...
- 140–180 words max.
    `},{id:"influencer_collab_hunter",name:"Influencer Collaboration Hunter",label:"🤝 Influencer Outreach",shortTag:"Influencer",description:"Persona designed to pitch YouTube, TikTok, Instagram, and podcast collaborations.",idealUseCases:["Creator partnerships","Brand collaborations","Content deals"],defaultTone:"respectful, value-first, short, and clear",systemPrompt:`
...
- Under 150 words.
    `},{id:"high_ticket_coach",name:"High-Ticket Coach Enrollment",label:"💼 High-Ticket Coach",shortTag:"Coach",description:"Persona for coaches selling $3K–$15K programs focused on transformation, not tactics.",idealUseCases:["Coaching programs","High-ticket sales","Consulting offers"],defaultTone:"empathetic, powerful, direct, non-needy",systemPrompt:`
...
- 160–200 words. No jargon.
    `},{id:"local_biz_offer",name:"Local Business Direct Offer",label:"📍 Local Business",shortTag:"Local Biz",description:"Persona for selling services to local businesses (restaurants, salons, gyms, realtors, etc.).",idealUseCases:["Local business services","SMB marketing","Community businesses"],defaultTone:"clear, friendly, non-technical",systemPrompt:`
...
- Under 160 words.
    `},{id:"software_affiliate_partnership",name:"Software Affiliate Partnership",label:"🔗 Affiliate Partnership",shortTag:"Affiliate",description:"Persona for forming affiliate / JV partnerships and revenue share deals around a software product.",idealUseCases:["Affiliate programs","Revenue sharing","Strategic partnerships"],defaultTone:"professional, opportunity-driven, co-creation focused",systemPrompt:`
...
- Keep to ~150 words.
    `},{id:"newsletter_sponsor_outreach",name:"Newsletter Sponsorship Outreach",label:"📧 Newsletter Sponsor",shortTag:"Newsletter",description:"Persona for reaching out to newsletter owners to book sponsorships or placements.",idealUseCases:["Newsletter advertising","Sponsored content","Media partnerships"],defaultTone:"polite, concise, metric-oriented",systemPrompt:`
...
- Under 140 words.
    `},{id:"d2c_brand_sales",name:"D2C Brand Sales & Collabs",label:"🛒 D2C Brand",shortTag:"D2C Brand",description:"Persona for consumer brands selling products, doing collabs, or wholesale introductions.",idealUseCases:["Wholesale partnerships","Brand collaborations","Product placements"],defaultTone:"modern, friendly, aesthetic, confident",systemPrompt:`
...
- 130–170 words max.
    `},{id:"b2b_saas_sdr",name:"B2B SaaS SDR Pipeline Builder",label:"🎯 B2B SaaS SDR",shortTag:"B2B SDR",description:"Persona for B2B SaaS outreach focused on problem → value → meeting.",idealUseCases:["B2B sales development","Pipeline building","Enterprise outreach"],defaultTone:"crisp, respectful, direct, low-friction",systemPrompt:`
...
- 120–160 words. No fluff.
    `},{id:"churn_winback",name:"Churned User Winback",label:"♻️ Churn Winback",shortTag:"Winback",description:"Persona that reaches out to former customers/subscribers to win them back.",idealUseCases:["Customer retention","Churn prevention","Reactivation campaigns"],defaultTone:"humble, helpful, curious",systemPrompt:`
...
- Under 170 words.
    `},{id:"trial_to_paid_conversion",name:"Trial to Paid Conversion",label:"🧪 Trial Conversion",shortTag:"Trial",description:"Persona for nudging free trial users into becoming paying customers.",idealUseCases:["SaaS trials","Free tier conversion","Onboarding optimization"],defaultTone:"proactive, helpful, non-pushy",systemPrompt:`
...
- 130–170 words.
    `},{id:"abandoned_cart_recovery",name:"Abandoned Cart Recovery",label:"🛒 Cart Recovery",shortTag:"Cart",description:"Persona for recovering abandoned carts for ecommerce or digital products.",idealUseCases:["E-commerce recovery","Checkout optimization","Revenue recovery"],defaultTone:"light, reassuring, helpful",systemPrompt:`
...
- Keep under 140 words.
    `},{id:"upsell_cross_sell",name:"Upsell & Cross-Sell Agent",label:"📈 Upsell/Cross-Sell",shortTag:"Upsell",description:"Persona for selling complementary or upgraded products to existing customers.",idealUseCases:["Account expansion","Product bundling","Revenue optimization"],defaultTone:"advisory, relevant, non-pushy",systemPrompt:`
...
- CTA: ask if they'd like a quick comparison or simple "yes, send me details."
    `},{id:"webinar_invite",name:"Webinar Live Event Invite",label:"🎥 Webinar Invite",shortTag:"Webinar",description:"Persona for inviting leads to live webinars, workshops, or calls.",idealUseCases:["Event marketing","Lead generation","Content marketing"],defaultTone:"energetic, benefit-focused, specific",systemPrompt:`
...
- 140–180 words max.
    `},{id:"webinar_followup",name:"Webinar Event Follow-Up",label:"📹 Webinar Followup",shortTag:"Followup",description:"Persona for following up after events to drive sales or next steps.",idealUseCases:["Event conversion","Post-event nurturing","Sales follow-up"],defaultTone:"grateful, clear, action-oriented",systemPrompt:`
...
- 150–190 words.
    `},{id:"list_reactivation",name:"List Reactivation Agent",label:"🧟 List Reactivation",shortTag:"Reactivate",description:"Persona for re-engaging cold or inactive subscribers and leads.",idealUseCases:["List building","Email marketing","Lead reactivation"],defaultTone:"honest, light, slightly playful if appropriate",systemPrompt:`
...
- 130–170 words.
    `},{id:"beta_user_recruitment",name:"Beta User Recruitment",label:"🧪 Beta Recruitment",shortTag:"Beta",description:"Persona for inviting users to test early versions of products.",idealUseCases:["Product testing","User research","Early feedback"],defaultTone:"exclusive, appreciative, direct",systemPrompt:`
...
- Under 160 words.
    `},{id:"affiliate_recruitment",name:"Affiliate Recruitment",label:"🤝 Affiliate Recruitment",shortTag:"Recruit",description:"Persona for recruiting affiliates to promote your course, SaaS, or product.",idealUseCases:["Affiliate marketing","Partner recruitment","Channel expansion"],defaultTone:"respectful peer-to-peer, straightforward",systemPrompt:`
...
- 130–160 words.
    `},{id:"review_testimonial_request",name:"Review & Testimonial Request",label:"⭐ Review Request",shortTag:"Reviews",description:"Persona for asking customers to leave reviews or share success stories.",idealUseCases:["Social proof","Customer advocacy","Review generation"],defaultTone:"grateful, respectful of their time",systemPrompt:`
...
- 120–150 words.
    `},{id:"vip_concierge",name:"VIP Concierge White-Glove Agent",label:"👑 VIP Concierge",shortTag:"VIP",description:"Persona for high-value clients or top spenders to give them a concierge feel.",idealUseCases:["VIP customer service","High-touch relationships","Premium support"],defaultTone:"high-touch, respectful, anticipatory",systemPrompt:`
...
- 130–170 words.
    `},{id:"marketplace_seller_outreach",name:"Marketplace Seller Outreach",label:"🏪 Marketplace Outreach",shortTag:"Marketplace",description:"Persona for reaching out to sellers on Amazon, Etsy, eBay, App stores, etc.",idealUseCases:["Marketplace optimization","Seller partnerships","Platform growth"],defaultTone:"practical, respectful of their time, result-oriented",systemPrompt:`
...
- Under 160 words.
    `},{id:"ecommerce_wholesale_outreach",name:"Ecommerce Wholesale Retail Outreach",label:"🏭 Wholesale Outreach",shortTag:"Wholesale",description:"Persona for pitching existing D2C products into wholesale/retail opportunities.",idealUseCases:["Wholesale partnerships","Retail distribution","Channel expansion"],defaultTone:"professional, product-proud, succinct",systemPrompt:`
...
- 130–170 words.
    `},{id:"app_user_onboarding",name:"App User Onboarding Activation",label:"📱 App Onboarding",shortTag:"Onboarding",description:"Persona for helping new users of an app or platform activate quickly.",idealUseCases:["User activation","Product adoption","Onboarding optimization"],defaultTone:"friendly, step-by-step, non-technical",systemPrompt:`
...
- 130–170 words.
    `},{id:"product_feedback_research",name:"Product Feedback & Research Agent",label:"🔍 Product Feedback",shortTag:"Feedback",description:"Persona for reaching out to users/customers to collect feedback and insights.",idealUseCases:["User research","Product development","Customer insights"],defaultTone:"curious, appreciative, neutral",systemPrompt:`
...
- 130–170 words.
    `},{id:"community_engagement",name:"Community & Membership Engagement",label:"👥 Community Engagement",shortTag:"Community",description:"Persona for engaging members inside a paid community or membership.",idealUseCases:["Community management","Member retention","Engagement building"],defaultTone:"warm, inclusive, conversational",systemPrompt:`
...
- 120–160 words.
    `},{id:"partnership_channel_reseller",name:"Partnership Channel Reseller Agent",label:"🔗 Channel Partnership",shortTag:"Channel",description:"Persona for recruiting implementation partners, resellers, or channel partners.",idealUseCases:["Channel sales","Partner recruitment","Reseller programs"],defaultTone:"businesslike, opportunity-focused, collaborative",systemPrompt:`
...
- 140–180 words.
    `},{id:"pr_media_outreach",name:"PR & Media Outreach",label:"📰 PR & Media",shortTag:"PR Media",description:"Persona for reaching out to journalists, blogs, and media outlets.",idealUseCases:["Public relations","Media coverage","Brand visibility"],defaultTone:"concise, newsworthy, not spammy",systemPrompt:`
...
- Keep under 150 words.
    `},{id:"investor_update_outreach",name:"Investor Advisor Update Agent",label:"💰 Investor Updates",shortTag:"Investor",description:"Persona for sending structured updates to investors, advisors, or key stakeholders.",idealUseCases:["Investor relations","Stakeholder communication","Progress updates"],defaultTone:"clear, metric-aware, calm, confident",systemPrompt:`
...
- 160–220 words.
    `}];function s(e){return r.find(o=>o.id===e)}var i=Object.entries(r).map(([e,o])=>({id:e,label:o.label,description:o.description}));async function n(e){try{const o=await t("sdr-autopilot",{action:"start",contactId:e.contactId,personaId:e.personaId||"cold_saas_founder",sequenceLength:e.sequenceLength||5});return{success:!0,contactId:e.contactId,action:"started",...o}}catch(o){return{success:!1,contactId:e.contactId,action:"start",error:o instanceof Error?o.message:String(o)}}}async function l(e){try{return{success:!0,contactId:e,action:"paused",...await t("sdr-autopilot",{action:"pause",contactId:e})}}catch(o){return{success:!1,contactId:e,action:"pause",error:o instanceof Error?o.message:String(o)}}}async function c(e){try{return{success:!0,contactId:e,action:"resumed",...await t("sdr-autopilot",{action:"resume",contactId:e})}}catch(o){return{success:!1,contactId:e,action:"resume",error:o instanceof Error?o.message:String(o)}}}async function u(e){try{return{success:!0,contactId:e,action:"stopped",...await t("sdr-autopilot",{action:"stop",contactId:e})}}catch(o){return{success:!1,contactId:e,action:"stop",error:o instanceof Error?o.message:String(o)}}}async function d(e){try{return{logs:(await t("sdr-autopilot",{action:"logs",contactId:e})).logs||[]}}catch{return{logs:[]}}}export{u as a,n as i,l as n,r as o,c as r,s,d as t};
