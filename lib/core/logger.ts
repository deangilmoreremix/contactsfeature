...
const LOG_LEVEL_MAP: Record<LogLevel, number> = { debug: 0, info: 1, warn: 2, error: 3 };
const MIN_LEVEL = LOG_LEVEL_MAP[(process.env.LOG_LEVEL as LogLevel) || "info"] || 1;
...
export const logger = {
  ...
  setCorrelationId: (id: string | null) => { _correlationId = id; },
};
